...
export const JourneyView: React.FC = () => {
  ...
  // Die letzten 28 Tage für die Heatmap
  ...
  // Statistiken für das "mysterische" Gefühl
  const totalVolume = useMemo(() => 
    (state.records || []).reduce((sum, r) => sum + (r.value || 0), 0)
  , [state.records]);

  // Bestimmt die Farbe/Deckkraft basierend auf der Intensität
      ...
      {showSettings ? (
        ...
        <div className="space-y-12">
          ...
          <div className="p-8 bg-base-card rounded-ios border border-border-thin">
            <h3 className="text-[10px] uppercase tracking-[0.3em] text-text-dim mb-6 flex items-center gap-2">
            ...
            <div className="mt-6 flex justify-between items-center text-[8px] uppercase tracking-widest text-text-dim/40">
              <span>Void</span>
